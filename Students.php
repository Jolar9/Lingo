...
session_start();
if (!isset($_SESSION['email']) && ($_SESSION['role'] != 'tutor')) { /// ($_SESSION['role']!='student')
...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
      ...
      <div class="message-request mb-4">
        ...
        <div class="message-content">
          ...
          <div class="button-container">
            <a href="contactTutor.html"><button class="btn">Contact</button></a>
          </div>
        </div>
      </div>
      ...
      <?php
         ...
         if (mysqli_num_rows($result) > 0) {
           ...
           >
             ...
             echo "<h4 class='mb-0'>{$row['student']}</h4>";
             echo "</div>";
             echo "<div class='message-content'>";
             echo "<div class='info'>
             <h5>Language: {$row['language']}</h5>
             <h5>Level: {$row['level']}</h5>
           </div>
           <div class='button-container'>
             <a href='contactTutor.html'><button class='btn'>Contact</button></a>
           </div>";
