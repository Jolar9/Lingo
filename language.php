...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  $student = $_SESSION["firstname"]; //TODO: use full name by concatination
  $language = $_POST["language"];
 


  $sql = "INSERT INTO StudentSession (student, language) VALUES ('$student', '$language')"; 
...
<html>
 <head>
  ...
  <link rel="stylesheet" type ="text/css" href="PostLanguage.css">
   ...
   <button
    ...
    <form form method="post">
      ...
      <br>
        <div id="border">
          <div class="center">
          <h3 >Which langauge you want to learn?</h3>
        </div>

       <div class="one"> <input type="checkbox" value="English" name="language"> English<br> </div>
       <div class="one"><input type="checkbox" value="Spanish" name="language"> Spanish<br></div>
       <div class="one"><input type="checkbox" value="French" name="language"> French<br></div>
       <div class="one"> <input type="checkbox" value="Japanese" name="language"> Japanese<br> </div>
       <div class="one"><input type="checkbox" value="Italian" name="language"> Italian<br></div>
       <div class="one"><input type="checkbox" value="Other" name="language"> Other<br></div>
       <div class="button"></div><button type="next" class="next">next</button></div>
        </div>
        </form>
        </div>
