...
if (isset($_SESSION['id']) && ($_SESSION['role'])=='student'){ //change username to email
  // header() is used to send a raw HTTP header. It must be called before any actual output is sent.
  header("Location: StudentHome.php");
} else if (isset($_SESSION['id']) && ($_SESSION['role'])=='tutor'){
...
<link href="https://fonts.googleapis.com/css2?family=Mulish:ital,wght@0,200..1000;1,200..1000&family=Open+Sans:ital,wght@0,300..800;1,300..800&family=Quicksand:wght@300..700&family=Raleway:ital,wght@0,100..900;1,100..900&display=swap" 
rel="stylesheet" />
      ...
      <body>
        <div class="center">
          ...
          <form action="checklogin.php" method="post">
            <!-- error in loging in, get error from checklogin.php (ndex.php?error=Wrong Username/Password) or mypage.php (index.php?error=Please Sign In again!)-->
            <?php
                            if(isset($_GET['error']))
        ...
        <footer class="footer mt-auto py-3">
          ...
          <br><br> <br> <br><br> <br> 
            ...
            <style>
              ...
              .custom-submit-btn:hover {
                  background-color: #9fbbcc; /* Hover background color */
              }
          </style>
          ...
          <div class="d-flex flex-column flex-sm-row w-100 gap-2">
              ...
              />
              <button class="btn btn-primary custom-submit-btn" type="button">Subscribe</button>
          </div>
