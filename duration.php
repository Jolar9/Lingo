...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE StudentSession SET duration=? WHERE id=?";
...
<form method="post">
    <div class="container">
      ...
      <div id="border">
        <div class="center">
          <h3 >How long do you want the session?</h3>
        <br>
        <br>
        </div>
          ...
          <div class="mydiv"> <input type="radio" value="One hour" name="duration"> One hour<br> </div>
          <div class="mydiv"><input type="radio" value="Two hours" name="duration"> Two hour<br></div>
          <div class="mydiv"><input type="radio" value="Three hours" name="duration"> Three hour<br></div>
