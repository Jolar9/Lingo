...
if (!isset($_SESSION['email']) && ($_SESSION['role'] != 'student')) { // should be || i think
  header("Location: LogInPage.php?error=Please Sign In again!");
  exit;
}
...
<body style="background-color: #f4f0ed;">
  ...
  <div class="teacher-details">
    <div class="teacher-info">
      <img src="https://cdn-icons-png.freepik.com/512/6858/6858441.png" alt="Teacher's Name" />


      <!-- <p>
        Certified Native English tutor, teaching students from all over the
        world 😊. Hello there 😊. My name is Joud and I am a Saudi native,
        English is my first language. I seek to teach English and empower my
        ...
        certificate to teach, and I am an English native.
      </p>
      <p>Spoken Languages: English, Spanish, French</p>
    </div>
    ...
    <div class="teacher-ratings">
      ...
      <div class="rating">
        ...
        <p>Excellent teacher! Very knowledgeable and patient.</p>
      </div>
      <div class="rating">
        <span class="rating-stars">&#9733;&#9733;&#9733;&#9733;</span>
        <p>Good teacher, but could improve on explaining complex topics.</p>
      </div>
      <div class="rating">
        <span class="rating-stars">&#9733;&#9733;&#9733;&#9733;</span>
        <p>GOAT!!</p>
      ...
      <div class="rating">
        <span class="rating-stars">&#9733;&#9733;&#9733;&#9733;</span>
        <p>Great teacher i would love to take another course with him</p>
      </div>
      <div class="rating">
        <span class="rating-stars">&#9733;&#9733;&#9733;&#9733;</span>
        <p>Good teacher!!!!!!</p>
     ...
     Add more ratings and reviews as needed -->
    </div> 
    <?php
    if (isset($_GET['id'])) {
    ...
    <div class="buttons">
      ...
      <button class="book-class-btn">Book Class</button>
    </div>
  </div>
