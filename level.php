...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE StudentSession SET level=? WHERE id=?";
...
<form form method="post">
    <div class="container">
      ...
      <div id="border">
       ...
       <div class="one"> <input type="radio" value="Beginner" name="level"> Beginner<br> </div>
       <div class="one"><input type="radio" value="Elementary" name="level"> Elementary<br></div>
       <div class="one"><input type="radio" value="Intermediate" name="level"> Intermediate<br></div>
       <div class="one"> <input type="radio" value="Upper Intermediate" name="level"> Upper Intermediate<br> </div>
       <div class="one"><input type="radio" value="Advanced" name="level"> Advanced<br></div>
       <div class="one"><input type="radio" value="Master" name="level"> Master<br></div>
